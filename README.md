...
```bash
git clone https://github.com/rvanbaalen/json-server-heroku
```
...
## Deploy to **Heroku**
<a href="https://heroku.com/deploy?template=https://github.com/rvanbaalen/json-server-heroku/tree/master">
